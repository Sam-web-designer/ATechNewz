    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters d-flex justify-content-center">
            <div class="col-md-10 " >
                <div class="card-body">
                    <h2>Welcome to ATechNewz</h2>
                    <p>These terms of service outline the rules and regulations for the use of ATechNewz's Website.</p>
                    
                    
                    <p>By accessing this website we assume you accept these terms of service in full. Do not continue to use 
                        ATechNewz's website if you do not accept all of the terms of service stated on this page.</p>
                    ...
                    <h2>Cookies</h2>
                    <p>We employ the use of cookies. By using ATechNewz's website you consent to the use of cookies
                        in accordance with ATechNewz's privacy policy.</p>
                    ...
                    <h2>License</h2>
                    <p>Unless otherwise stated, ATechNewz and/or it's licensors own the intellectual property rights for
                        all material on ATechNewz. All intellectual property rights are reserved. You may view and/or print
                        pages from ATechNewz.com for your own personal use subject to restrictions set in these terms of service.</p>
                    <p>You must not:</p>
                    <ol>
                        <li>Republish material from ATechNewz.com</li>
                        <li>Sell, rent or sub-license material from ATechNewz.com</li>
                        <li>Reproduce, duplicate or copy material from ATechNewz.com</li>
                    </ol>
                    <p>Redistribute content from ATechNewz (unless content is specifically made for redistribution).</p>
                    ...
                    <ol>
                        ...
                        <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
                            material and data ('Comments') in areas of the website. ATechNewz does not screen, edit, publish
                            or review Comments prior to their appearance on the website and Comments do not reflect the views or
                            opinions of ATechNewz, its agents or affiliates. Comments reflect the view and opinion of the
                            person who posts such view or opinion. To the extent permitted by applicable laws ATechNewz shall
                            ...
                            website.</li>
                        <li>ATechNewz reserves the right to monitor all Comments and to remove any Comments which it considers
                        ...
                        <li>You hereby grant to <strong>ATechNewz</strong> a non-exclusive royalty-free license to use, reproduce,
                    ...
                    <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect
                        ...
                        the visibility associated with the hyperlink outweighs the absence of ATechNewz; and (d) where the
                    ...
                    <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
                        you must notify us by sending an e-mail to <a href="mailto:atechnewz@gmail.com" title="send an email to atechnewz@gmail.com">atechnewz@gmail.com</a>.
                    ...
                    <p>No use of ATechNewz's logo or other artwork will be allowed for linking absent a trademark license
                        agreement.</p>
