        ...
        <div id="loading" style="background: #fff url({{asset('front_asset/images/logo/loader.gif')}}) no-repeat center center;	"></div>
            ...
            <section>
                <div class="feature-photo">
                    <figure><img src="{{asset('front_asset/logo/coverimage1.jpg')}}"></figure>
                        ...
                        <div class="row merged">
                            <div class="col-lg-2 col-sm-3">
                                <div class="user-avatar">
                                    <figure>
                                        @if ($post['0']->avatar == 'default.png')
                                            <img src="{{asset('front_asset/images/default.png')}}" alt="">
                                        @else
                                               <img src="{{asset('/storage/userimage/'.$post['0']->avatar)}}" alt="">
                                        @endif
                                       
                                        @if (session()->get('user')['id'] == $post['0']->id)
                            ...
                            <div class="col-lg-10 col-sm-9">
                                <div class="timeline-info">
                                    <ul>
                                        <li class="admin-name">
                                          <h6>{{$post['0']->name}} @if ($post['0']->role_id == 'yes' )
                                              <span><i style="color:#007bff" class="fas fa-check-circle"></i></span>
                                          @endif </h6>
                                          <p><div  id="follow-user-id">
                                                @include('front.userprofile.unfollow-follow')
                                           </div></p>
                                        </li>
                                        <li>
                                            <a class="active" href="{{$post['0']->name}}" >time line</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="row d-flex justify-content-center" id="page-contents">
                                    ...
                                    <div class="col-lg-6 ">
                                        ...
                                        <div id="like-user-index">
                                            @include('front.userprofile.userpost')
                                        </div>
      ...
      <div id="modal-center" class="uk-flex-top" uk-modal>
        <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical" style="border-radius: 10px;">
                ...
                <div class="d-flex justify-content-center">
                    <div style="display: block"><img src="{{asset('front_asset/logo/logo2.png')}} " alt="">
                    <p class="text-center" style="font-size:20px;">Please Login or Register</p><br/>	
                    <div class="text-center"> <a id="if-login" href="/login">Login</a> <a id="if-login" href="/register">Register</a></div>
                    </div>
                </div>
            </div>
        </div>
